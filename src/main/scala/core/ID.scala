...
object IDMap {
  ...
  val instrMap = Array(
    ...
    JALR       -> List(PC_JLR   ,A_PC    ,B_IMM,   IMM_I  ,OP_ADD,  Br_XXX,  WIDTH_X   ,SIG_X   ,MEM_N  ,DATA_PC4   ,WB_W),
    ...
    SH         -> List(PC_4     ,A_RS1   ,B_IMM,   IMM_S  ,OP_ADD,  Br_XXX,  WIDTH_H   ,SIG_X   ,MEM_W  ,DATA_RS2   ,WB_N),
    SW         -> List(PC_4     ,A_RS1   ,B_IMM,   IMM_S  ,OP_ADD,  Br_XXX,  WIDTH_W   ,SIG_X   ,MEM_W  ,DATA_RS2   ,WB_N),
    ...
    SD         -> List(PC_4     ,A_RS1   ,B_IMM,   IMM_I  ,OP_ADD,  Br_XXX,  WIDTH_D   ,SIG_X   ,MEM_W  ,DATA_MEM   ,WB_N)
    )
}
